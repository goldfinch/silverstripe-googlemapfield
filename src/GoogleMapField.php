...
class GoogleMapField extends FormField {
	...
	protected function requireDependencies() {
        ...
        Requirements::css('goldfinch/silverstripe-googlemapfield: client/css/GoogleMapField.css');
        Requirements::javascript('goldfinch/silverstripe-googlemapfield: client/js/GoogleMapField.js');
